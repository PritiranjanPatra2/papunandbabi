/* global React */
// Ornament SVGs — mandalas, diyas, florals, peacocks, event icons.
// All inherit currentColor for theme-aware tinting.

const Mandala = ({ size = 240, opacity = 0.5, ...rest }) => (
...
// Spinning mandala wrapper
const SpinningMandala = ({ size, opacity, duration = 80, reverse = false, ...rest }) => (
  <div style={{
    animation: `${reverse ? 'spinR' : 'spin'} ${duration}s linear infinite`,
    display: 'inline-block', lineHeight: 0, ...rest.style,
  }} {...rest}>
...
// Filigree corner — top-left orientation by default
const Filigree = ({ size = 120, ...rest }) => (
  <svg viewBox="0 0 120 120" width={size} height={size} fill="none" stroke="currentColor" strokeWidth="0.8" {...rest}>
    <path d="M5 5 L40 5" />
    <path d="M5 5 L5 40" />
    <path d="M5 5 Q 22 22, 38 8 Q 50 0, 56 14" strokeDasharray="" />
...
const FourCorners = ({ size = 100, color = "var(--gold)", inset = 0 }) => (
  <>
...
// Decorative paisley/floral divider
...
// Lotus
const Lotus = ({ size = 60, opacity = 0.8 }) => (
...
// Peacock feather (simplified)
const Peacock = ({ size = 80, opacity = 0.7 }) => (
...
Object.assign(window, {
  Mandala, SpinningMandala, Filigree, FourCorners, Divider, Diya, Lotus, Peacock,
  IconHaldi, IconMehendi, IconSangeet, IconWedding, IconReception, IconMap,
  IconMusicOn, IconMusicOff, Particles, Petals,
});
